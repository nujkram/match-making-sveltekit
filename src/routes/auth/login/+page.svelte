	...
	>
		<div class="flex h-full items-center justify-center">
			<div class="text-white">
				<h2 class="mb-4 text-4xl font-semibold">{settings?.name || 'Cockfight Registration'}</h2>
...
<section class="text-gray-600 body-font">
	<div class="container px-5 py-24 mx-auto flex flex-wrap items-center">
		<div class="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0 translate-x-full animate-fade-in-left">
			<h1 class="title-font font-bold text-5xl text-gray-900">Cockfight Match Making</h1>
			<p class="leading-relaxed mt-4 text-sm">
				A matchmaking system is a software algorithm that matches entries based on specific criteria
			</p>
		</div>
